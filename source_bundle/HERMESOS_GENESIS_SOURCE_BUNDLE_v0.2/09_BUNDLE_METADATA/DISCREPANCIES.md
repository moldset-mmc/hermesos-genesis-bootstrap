...
## D-00 — Historical governance-status overlay integrated
**Historical record:** RC v0.1 required `KEEP_AS_IMPLEMENTATION_OVERLAY` for
`gateway/governance_status.py` because its source copy referenced HKP-INT-004
/ schema 1.3.

**Next-baseline treatment:** The corrected HKP-INT-006 / schema 1.0
implementation is now the direct source-bundle component. The historical RC
v0.1 source and overlay disposition remain untouched under the v0.1 bundle for
provenance, but v0.2 APPLY has no overlay mechanism for this file.
