...
INTEGRITY_MANIFEST_FILENAME = "HKP_INTEGRITY_MANIFEST_v6.0.json"
...
INTEGRITY_MANIFEST_ID = "HKP-INT-006"
...
def _manifest_integrity_verified(
    ...
    # HKP-INT-006 has 33 ordered source records. The opened RC2.6 manifest
    # contains a duplicate Foundation Index record; the authoritative boot probe
    # verifies each record in order and does not reject duplicates. Preserve that
    # compatibility behavior rather than imposing the legacy v1.3 uniqueness rule.
    # The action
    # policy file is independently bound and verified by hkp_policy_gate.py;
    # it is not a required member of the RC2.6 integrity manifest.
...
def render_governance_status(
    *,
    ...
    return (
        ...
        f"Integrity HKP-INT-006: {integrity}"
    )
...
def render_governance_diagnostic(
    *,
    ...
    return (
        ...
        "HKP_INTEGRITY_MANIFEST_v6.0.json\n"
